...
const MediaContextProvider = ({children}) => {
  ...
  const isExtraSmall = useMediaQuery({ query: '(max-width: 360px)'})
  ...
  return (
    <MediaContext.Provider value={{ isExtraSmall, isMobileDevice, isSmallScreen, isTabletDevice, isDesktopDevice, isLargeScreen }}>
      {children}
